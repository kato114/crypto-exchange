...
@section('body')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title ">Edit Currency
                ...
                <div class="tile-body">
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <form role="form" method="POST" action="{{route('currency.update',$currency)}}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-lg"
                                                   placeholder="Currency / Country Name" value="{{$currency->name}}"
                                                   name="name">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-append">
                                                <span
                                                    class="input-group-text"><strong> 1 = {{$basic->currency}}</strong></span>
                                            </div>
                                            <input type="text" name="price" value="{{$currency->price}}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="available_balance"
                                                   value="{{$currency->available_balance}}"
                                                   class="form-control form-control-lg"
                                                   placeholder="0.00"
                                                   onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                            <div class="input-group-append">
                                                <span
                                                    class="input-group-text"><strong>{{$currency->symbol}}</strong></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <h5> Payment ID</h5>
                                        <input type="text" name="payment_id" value="{{$currency->payment_id}}"
                                               name="payment_id" class="form-control form-control-lg"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="exchange" value="{{$currency->exchange}}"
                                                   name="exchange" class="form-control form-control-lg"
                                                   placeholder="0.00"
                                                   onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <input data-toggle="toggle" data-size="large" data-onstyle="success"
                                                   ...
                                                   name="is_coin"
                                                   @if($currency->is_coin == 1) checked @endif>
                                        </div>
                                        <div class="form-group ">
                                            <h5>Status:</h5>
                                            <input data-toggle="toggle" data-size="large" data-onstyle="success"
                                            ...
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;"
                                                ...
                                                @if($currency->image == null)
                                                    <img style="width: 200px"
                                                         ...
                                                         alt="...">
                                                @else
                                                    <img style="width: 35px; height: 25px; margin-top: 80px;"
                                                         src="{{ asset('assets/images/currency') }}/{{ $currency->image }}"
                                                         alt="...">
                                                @endif
