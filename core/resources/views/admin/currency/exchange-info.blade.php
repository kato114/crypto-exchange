        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-title d-print-none"><i class="fa fa-exchange"></i>
                    ...
                    @else
                        <a href="#" class="btn btn-info btn-md pull-right " data-toggle="modal"
                ...
                <div class="tile-body">
                    ...
                    <section class="invoice">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="From Exchange">
                                            <strong>{{number_format($exchange->from_amount)}} {{$exchange->fromCurrency->symbol}}</strong>
                                        </td>
                                        <td data-label="To Exchange">
                                            <strong>{{number_format($exchange->receive_amount)}} {{$exchange->toCurrency->symbol}}</strong>
                                        </td>
                        ...
                        <div class="row invoice-info">
                            <div class="col-md-4">
                                <h5>Transaction /slip Number : </h5>
                                <h5 class="error"> {{$exchange->transaction_number}}</h5>
                                <br>
                                <h5>Transaction screenshot : </h5>
                                <img src="{{asset('assets/images/exchange/'.$exchange->image)}}" alt="..." class="img-thumbnail">
                            </div>
                            <div class="col-md-4">
                                <h5>{{$exchange->user->username}}'s {{$exchange->toCurrency->name}} Account : </h5>
                                <h5 class="error">{{$exchange->user_payment_id}} </h5>
                            </div>
                            <div class="col-md-4">
                                <h5>Message : </h5>
                                <p>{{$exchange->info}} </p>
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel2"><i class='fa fa-info-circle'></i> Exchange Currency
                        Confirmation</h4>
                ...
                <form action="{{route('exchange-action')}}" method="post">
                    @csrf
