                            ...
                            @foreach($exchange as $k=>$data)
                                <tr>
                                    ...
                                    <td data-label="Send Amount">
                                        <strong>{{$data->enter_amount}} {{$data->currency->symbol}}</strong>
                                    </td>
                                    <td data-label="Get Currency">
                                        <strong>{{number_format($data->get_amount, $basic->decimal)}} {{$basic->currency}}</strong>
                                    </td>
                                    ...
                                    <td data-label="Action">
                                        <a href="{{route('sell-info',$data->id)}}"
