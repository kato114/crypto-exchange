                            ...
                            @foreach($exchange as $k=>$data)
                                <tr>
                                    ...
                                    <td data-label="Send Amount">
                                        <strong>{{number_format($data->enter_amount, $basic->decimal)}} {{$basic->currency}}</strong>
                                    </td>
                                    <td data-label="Get Currency">
                                        <strong>{{$data->get_amount}} {{$data->currency->symbol}}</strong>
                                    </td>
